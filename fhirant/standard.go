...
//     app.RootCmd.PersistentFlags().BoolVar(&indexFallback, "indexFallback", true, "fallback to index.html on missing static path")
...
//         app.Settings().Batch.Timeout .DatabaseTimeout = time.Duration(queryTimeout) * time.Second
//         return nil
//     })

...
Future<void> createTestReportTables(Database db) async {
  await db.execute('''
...
Future<bool> saveTestReport(Database db, TestReport resource) async {
...
Future<TestReport?> getTestReport(Database db, String id) async {
  try {

...
Future<void> createCompositionTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveComposition(Transaction txn, Composition resource) async {
...
Future<Composition?> getComposition(Transaction txn, String id) async {
  try {

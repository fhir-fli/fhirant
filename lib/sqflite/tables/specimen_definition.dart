...
Future<void> createSpecimenDefinitionTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveSpecimenDefinition(
    Transaction txn, SpecimenDefinition resource,) async {
  ...
  try {
    ...
    await txn.rawInsert(
      '''
      INSERT OR REPLACE INTO SpecimenDefinition (
        id, lastUpdated, resource
      ) VALUES (?, ?, ?)
      ''',
      [
...
Future<SpecimenDefinition?> getSpecimenDefinition(

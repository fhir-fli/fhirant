...
/// [Substance] resources
Future<void> createSubstanceTables(Database db) async {
  await db.execute('''
...
Future<bool> saveSubstance(Database db, Substance resource) async {
...
Future<Substance?> getSubstance(Database db, String id) async {
  try {

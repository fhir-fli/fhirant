...
Future<void> createAuditEventTables(Database db) async {
  await db.execute('''
...
Future<bool> saveAuditEvent(Database db, AuditEvent resource) async {
...
Future<AuditEvent?> getAuditEvent(Database db, String id) async {
  try {

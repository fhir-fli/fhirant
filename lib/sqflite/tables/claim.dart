...
/// [Claim] resources
Future<void> createClaimTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveClaim(Transaction txn, Claim resource) async {
...
Future<Claim?> getClaim(Transaction txn, String id) async {
  try {

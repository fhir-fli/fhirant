...
Future<void> createOrganizationTables(Database db) async {
  await db.execute('''
...
Future<bool> saveOrganization(Database db, Organization resource) async {
...
Future<Organization?> getOrganization(Database db, String id) async {
  try {

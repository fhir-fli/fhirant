...
/// [Binary] resources
Future<void> createBinaryTables(Database db) async {
  await db.execute('''
...
Future<bool> saveBinary(Database db, Binary resource) async {
...
Future<Binary?> getBinary(Database db, String id) async {
  try {

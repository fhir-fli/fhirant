...
Future<void> createClaimResponseTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveClaimResponse(Transaction txn, ClaimResponse resource) async {
...
Future<ClaimResponse?> getClaimResponse(Transaction txn, String id) async {
  try {

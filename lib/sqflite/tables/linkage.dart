...
/// [Linkage] resources
Future<void> createLinkageTables(Database db) async {
  await db.execute('''
...
Future<bool> saveLinkage(Database db, Linkage resource) async {
...
Future<Linkage?> getLinkage(Database db, String id) async {
  try {

...
/// [Flag] resources
Future<void> createFlagTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveFlag(Transaction txn, Flag resource) async {
...
Future<Flag?> getFlag(Transaction txn, String id) async {
  try {

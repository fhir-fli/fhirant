...
/// [Device] resources
Future<void> createDeviceTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveDevice(Transaction txn, Device resource) async {
...
Future<Device?> getDevice(Transaction txn, String id) async {
  try {

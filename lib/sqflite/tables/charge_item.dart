...
Future<void> createChargeItemTables(Database db) async {
  await db.execute('''
...
Future<bool> saveChargeItem(Database db, ChargeItem resource) async {
...
Future<ChargeItem?> getChargeItem(Database db, String id) async {
  try {

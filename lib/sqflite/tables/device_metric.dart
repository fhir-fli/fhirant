...
Future<void> createDeviceMetricTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveDeviceMetric(Transaction txn, DeviceMetric resource) async {
...
Future<DeviceMetric?> getDeviceMetric(Transaction txn, String id) async {
  try {

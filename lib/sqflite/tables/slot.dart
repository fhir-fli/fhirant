...
/// [Slot] resources
Future<void> createSlotTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveSlot(Transaction txn, Slot resource) async {
...
Future<Slot?> getSlot(Transaction txn, String id) async {
  try {

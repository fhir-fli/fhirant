...
Future<void> createTestScriptTables(Database db) async {
  await db.execute('''
...
Future<bool> saveTestScript(Database db, TestScript resource) async {
...
Future<TestScript?> getTestScript(Database db, String id) async {
  try {

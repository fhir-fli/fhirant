...
Future<void> createCoverageEligibilityResponseTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveCoverageEligibilityResponse(
    Transaction txn, CoverageEligibilityResponse resource,) async {
  ...
  try {
    ...
    await txn.rawInsert(
      '''
      INSERT OR REPLACE INTO CoverageEligibilityResponse (
        id, lastUpdated, resource
      ) VALUES (?, ?, ?)
      ''',
      [
...
Future<CoverageEligibilityResponse?> getCoverageEligibilityResponse(

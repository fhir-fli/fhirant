...
Future<void> createRiskAssessmentTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveRiskAssessment(
    Transaction txn, RiskAssessment resource,) async {
...
Future<RiskAssessment?> getRiskAssessment(Transaction txn, String id) async {
  try {

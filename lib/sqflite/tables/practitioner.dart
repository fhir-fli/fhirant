...
Future<void> createPractitionerTables(Database db) async {
  await db.execute('''
...
Future<bool> savePractitioner(Database db, Practitioner resource) async {
...
Future<Practitioner?> getPractitioner(Database db, String id) async {
  try {

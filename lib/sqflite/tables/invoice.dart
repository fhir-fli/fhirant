...
/// [Invoice] resources
Future<void> createInvoiceTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveInvoice(Transaction txn, Invoice resource) async {
  ...
  try {
    final existingResource = await txn.rawQuery(
      'SELECT id, resource, lastUpdated FROM Invoice WHERE id = ?',
      [id],
    );
...
Future<Invoice?> getInvoice(Transaction txn, String id) async {
  try {

...
/// [Invoice] resources
Future<void> createInvoiceTables(Database db) async {
  await db.execute('''
...
Future<bool> saveInvoice(Database db, Invoice resource) async {
...
Future<Invoice?> getInvoice(Database db, String id) async {
  try {

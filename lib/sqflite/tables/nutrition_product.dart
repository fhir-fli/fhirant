...
Future<void> createNutritionProductTables(Database db) async {
  await db.execute('''
...
Future<bool> saveNutritionProduct(
    Database db, NutritionProduct resource,) async {
...
Future<NutritionProduct?> getNutritionProduct(Database db, String id) async {
  try {

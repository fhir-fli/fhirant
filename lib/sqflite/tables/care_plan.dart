...
/// [CarePlan] resources
Future<void> createCarePlanTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveCarePlan(Transaction txn, CarePlan resource) async {
...
Future<CarePlan?> getCarePlan(Transaction txn, String id) async {
  try {

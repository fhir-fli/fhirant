...
Future<void> createLibraryTables(Transaction txn) async {
  await txn.execute('''
    ...
    ''');
  await txn.execute('''
    CREATE INDEX IF NOT EXISTS idx_library_url
    ON Library (url)
    ''');
  await txn.execute('''
...
Future<bool> saveLibrary(Transaction txn, Library resource) async {
...
Future<Library?> getLibrary(Transaction txn, String id) async {
  try {

...
Future<void> createParametersTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveParameters(Transaction txn, Parameters resource) async {
...
Future<Parameters?> getParameters(Transaction txn, String id) async {
  try {

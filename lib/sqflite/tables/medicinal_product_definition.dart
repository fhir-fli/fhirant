...
Future<void> createMedicinalProductDefinitionTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveMedicinalProductDefinition(
    Transaction txn, MedicinalProductDefinition resource,) async {
  ...
  try {
    ...
    await txn.rawInsert(
      '''
      INSERT OR REPLACE INTO MedicinalProductDefinition (
        id, lastUpdated, resource
      ) VALUES (?, ?, ?)
      ''',
      [
...
Future<MedicinalProductDefinition?> getMedicinalProductDefinition(

...
/// [Evidence] resources
Future<void> createEvidenceTables(Database db) async {
  await db.execute('''
...
Future<bool> saveEvidence(Database db, Evidence resource) async {
...
Future<Evidence?> getEvidence(Database db, String id) async {
  try {

...
Future<void> createResearchSubjectTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveResearchSubject(
    Transaction txn, ResearchSubject resource,) async {
...
Future<ResearchSubject?> getResearchSubject(Transaction txn, String id) async {
  try {

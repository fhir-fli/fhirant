...
Future<void> createDeviceDefinitionTables(Transaction txn) async {
  await txn.execute('''
...
Future<bool> saveDeviceDefinition(
    Transaction txn, DeviceDefinition resource,) async {
...
Future<DeviceDefinition?> getDeviceDefinition(

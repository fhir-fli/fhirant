...
**1,479 tests** across 140 test files, all passing (counted 2026-09-14; server recounted 2026-09-22).

- **Server tests** (1,317 tests, 128 files): `cd packages/fhirant_server && dart test`

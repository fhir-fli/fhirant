...
**1,362 tests** across 113 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,200 tests, 101 files): `cd packages/fhirant_server && dart test`

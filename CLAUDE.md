...
**1,481 tests** across 142 test files, all passing (counted 2026-09-14; server recounted 2026-09-22).

- **Server tests** (1,319 tests, 130 files): `cd packages/fhirant_server && dart test`

...
**1,312 tests** across 105 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,149 tests, 93 files): `cd packages/fhirant_server && dart test`

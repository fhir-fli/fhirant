...
**1,119 tests** across 89 test files, all passing (counted 2026-09-07).

- **Server tests** (966 tests, 78 files): `cd packages/fhirant_server && dart test`
- **DB tests** (120 tests, 5 files): `cd packages/fhirant_db && dart test`

...
**1,430 tests** across 126 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,268 tests, 114 files): `cd packages/fhirant_server && dart test`

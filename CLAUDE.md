...
**1,382 tests** across 117 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,220 tests, 105 files): `cd packages/fhirant_server && dart test`

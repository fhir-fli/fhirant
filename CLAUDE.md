...
**1,395 tests** across 120 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,233 tests, 108 files): `cd packages/fhirant_server && dart test`

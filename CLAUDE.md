...
**1,448 tests** across 130 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,286 tests, 118 files): `cd packages/fhirant_server && dart test`

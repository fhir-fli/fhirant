...
**1,432 tests** across 127 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,270 tests, 115 files): `cd packages/fhirant_server && dart test`

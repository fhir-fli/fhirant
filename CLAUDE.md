...
**1,295 tests** across 103 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,132 tests, 91 files): `cd packages/fhirant_server && dart test`

...
**1,442 tests** across 129 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,280 tests, 117 files): `cd packages/fhirant_server && dart test`

...
**1,389 tests** across 119 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,227 tests, 107 files): `cd packages/fhirant_server && dart test`

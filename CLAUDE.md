...
**1,369 tests** across 115 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,207 tests, 103 files): `cd packages/fhirant_server && dart test`

...
**1,340 tests** across 110 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,177 tests, 98 files): `cd packages/fhirant_server && dart test`

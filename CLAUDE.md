...
**1,452 tests** across 131 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,290 tests, 119 files): `cd packages/fhirant_server && dart test`

...
**1,386 tests** across 118 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,224 tests, 106 files): `cd packages/fhirant_server && dart test`

...
**1,368 tests** across 114 test files, all passing (counted 2026-09-14; server recounted 2026-09-18).

- **Server tests** (1,206 tests, 102 files): `cd packages/fhirant_server && dart test`

...
**1,331 tests** across 108 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,168 tests, 96 files): `cd packages/fhirant_server && dart test`

...
**1,294 tests** across 103 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,131 tests, 91 files): `cd packages/fhirant_server && dart test`

...
**1,302 tests** across 104 test files, all passing (counted 2026-09-14; server recounted 2026-09-17).

- **Server tests** (1,139 tests, 92 files): `cd packages/fhirant_server && dart test`

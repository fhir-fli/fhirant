...
**1,480 tests** across 141 test files, all passing (counted 2026-09-14; server recounted 2026-09-22).

- **Server tests** (1,318 tests, 129 files): `cd packages/fhirant_server && dart test`

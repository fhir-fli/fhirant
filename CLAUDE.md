...
**1,439 tests** across 128 test files, all passing (counted 2026-09-14; server recounted 2026-09-19).

- **Server tests** (1,277 tests, 116 files): `cd packages/fhirant_server && dart test`

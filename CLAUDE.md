...
**1,478 tests** across 139 test files, all passing (counted 2026-09-14; server recounted 2026-09-22).

- **Server tests** (1,316 tests, 127 files): `cd packages/fhirant_server && dart test`

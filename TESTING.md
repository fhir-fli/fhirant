...
**1,363 tests** across 113 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,201 | 101 | `cd packages/fhirant_server && dart test` |

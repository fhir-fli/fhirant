...
**1,370 tests** across 115 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,208 | 103 | `cd packages/fhirant_server && dart test` |

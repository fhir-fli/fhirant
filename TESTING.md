...
**1,389 tests** across 119 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,227 | 107 | `cd packages/fhirant_server && dart test` |

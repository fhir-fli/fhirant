...
**1,331 tests** across 108 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-17) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,168 | 96 | `cd packages/fhirant_server && dart test` |

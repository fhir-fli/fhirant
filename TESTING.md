...
**1,368 tests** across 114 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,206 | 102 | `cd packages/fhirant_server && dart test` |

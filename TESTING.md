...
**1,463 tests** across 133 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-19) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,301 | 121 | `cd packages/fhirant_server && dart test` |

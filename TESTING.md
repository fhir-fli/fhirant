...
**1,295 tests** across 103 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-17) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,132 | 91 | `cd packages/fhirant_server && dart test` |

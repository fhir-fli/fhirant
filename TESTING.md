...
**1,432 tests** across 127 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-19) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,270 | 115 | `cd packages/fhirant_server && dart test` |

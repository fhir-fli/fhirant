...
**1,302 tests** across 104 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-17) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,139 | 92 | `cd packages/fhirant_server && dart test` |

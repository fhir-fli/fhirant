...
**1,316 tests** across 106 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-17) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,153 | 94 | `cd packages/fhirant_server && dart test` |

...
**1,481 tests** across 142 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-22) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,319 | 130 | `cd packages/fhirant_server && dart test` |

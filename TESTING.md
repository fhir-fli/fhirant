...
**1,439 tests** across 128 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-19) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,277 | 116 | `cd packages/fhirant_server && dart test` |

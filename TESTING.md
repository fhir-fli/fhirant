...
**1,362 tests** across 113 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,200 | 101 | `cd packages/fhirant_server && dart test` |

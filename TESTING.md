...
**1,486 tests** across 144 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-22) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,324 | 132 | `cd packages/fhirant_server && dart test` |

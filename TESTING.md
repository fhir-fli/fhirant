...
**1,399 tests** across 121 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-18) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,237 | 109 | `cd packages/fhirant_server && dart test` |

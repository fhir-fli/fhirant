...
**1,485 tests** across 143 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-22) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,323 | 131 | `cd packages/fhirant_server && dart test` |

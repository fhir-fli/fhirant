...
**1,478 tests** across 139 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-22) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,316 | 127 | `cd packages/fhirant_server && dart test` |

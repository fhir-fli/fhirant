...
**1,477 tests** across 138 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-22) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,315 | 126 | `cd packages/fhirant_server && dart test` |

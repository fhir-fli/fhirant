...
**1,312 tests** across 105 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-17) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,149 | 93 | `cd packages/fhirant_server && dart test` |

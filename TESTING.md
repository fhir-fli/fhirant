...
**1,464 tests** across 135 test files, all passing. Counted 2026-09-14 (server recounted 2026-09-19) by
...
|---------|-------|-------|---------|
| fhirant_server | 1,302 | 123 | `cd packages/fhirant_server && dart test` |
